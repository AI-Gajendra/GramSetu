                        ...
                        <div className="container mx-auto grid gap-12 lg:grid-cols-2 lg:items-center">
                            <div className="flex flex-col gap-6 text-left relative z-10">
                                ...
                                <div className="mt-6 flex flex-wrap gap-4">
                                    <Link href="/login" className="flex items-center justify-center rounded-xl bg-gradient-to-r from-primary to-primary-dark px-8 py-3.5 text-base font-bold text-white shadow-xl shadow-primary/30 transition-all hover:-translate-y-1 hover:shadow-primary/50 relative overflow-hidden group">
                        ...
                        <div className="container mx-auto relative z-10">
                            <div className="glass-dark rounded-[3rem] p-10 md:p-16 lg:p-20 text-center border border-white/10 shadow-2xl backdrop-blur-2xl">
                                ...
                                <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
                                    <Link href="/login" className="w-full sm:w-auto rounded-xl bg-gradient-to-r from-primary to-primary-dark px-10 py-5 text-lg font-bold text-white shadow-xl shadow-primary/40 transition-all hover:shadow-primary/60 hover:-translate-y-1 hover:scale-105 active:scale-95 flex items-center justify-center gap-2">
