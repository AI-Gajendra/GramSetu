...
export default function DashboardPage() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                // Try fetching profile from backend using phone stored in user data
                if (user?.phone) {
        ...
        <div className="bg-background-light dark:bg-[#0a1511] font-display text-text-main antialiased min-h-screen flex flex-col relative overflow-hidden">
            ...
            <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-gray-200/50 dark:border-white/5 bg-white/70 dark:bg-surface-dark/70 backdrop-blur-xl px-6 py-3 shadow-sm transition-all">
                ...
                <nav className="hidden md:flex items-center gap-10">
                    <Link to="/" className="text-text-secondary dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors text-sm font-semibold">Home</Link>
                ...
                {loadingProfile ? (
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <Link to="/assistant" className="bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 hover:border-primary/30 transition-all hover:-translate-y-1 hover:shadow-xl group cursor-pointer flex items-center gap-5">
                            ...
                            <button
                                ...
                                className="bg-white dark:bg-surface-dark rounded-2xl p-6 shadow-lg shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 hover:border-red-300 transition-all hover:-translate-y-1 hover:shadow-xl group cursor-pointer flex items-center gap-5 w-full text-left"
                            >
